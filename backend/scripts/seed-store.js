/**
 * Seed script — populates the store with demo perfume data.
 * Usage:  node scripts/seed-store.js
 * Reset:  node scripts/seed-store.js --reset
 */
...
const buildProducts = (cats) => {
  ...
  return [
    // ── Perfumes Mujer ───────────────────────────────────────────────────────
    {
      ...
      variantImages: {
        [`Edición:Clásica`]:  IMG(P.p1a),
        [`Edición:Intensa`]:  IMG(P.p2a),
        [`Edición:Limitada`]: IMG(P.p1b),
      },
      isActive: true,
    },
    {
      ...
      variantImages: {
        [`Aroma:Jazmín`]:   IMG(P.p2b),
        [`Aroma:Gardenia`]: IMG(P.p3a),
        [`Aroma:Vainilla`]: IMG(P.p1a),
      },
      isActive: true,
    },
    {
      ...
      variantImages: {
        [`Color:Rosa`]:   IMG(P.p3b),
        [`Color:Dorado`]: IMG(P.p4a),
        [`Color:Negro`]:  IMG(P.p2b),
      },
      isActive: true,
    },
    // ── Perfumes Hombre ──────────────────────────────────────────────────────
    {
      ...
      variantImages: {
        [`Versión:Original`]: IMG(P.p4b),
        [`Versión:Extreme`]:  IMG(P.p5a),
        [`Versión:Sport`]:    IMG(P.p3a),
      },
      isActive: true,
    },
    {
      name: "Océan Bleu",
      slug: "ocean-bleu",
      description: "Fresco y dinámico. Notas acuáticas, bergamota y un fondo de almizcle blanco y madera suave. Ideal para el hombre activo.",
      price: 70,
      stock: 22,
      category: hombre,
      ...
      variantImages: {
        [`Intensidad:Eau de Toilette`]: IMG(P.p5b),
        [`Intensidad:Eau de Parfum`]:   IMG(P.p6a),
      },
      isActive: true,
    },
    {
      ...
      variantImages: {
        [`Edición:Ámbar`]:    IMG(P.p6b),
        [`Edición:Oud`]:      IMG(P.p1a),
        [`Edición:Especias`]: IMG(P.p5a),
      },
      isActive: true,
    },
    // ── Sets & Regalos ───────────────────────────────────────────────────────
    {
      name: "Set Romantique",
      slug: "set-romantique",
      description: "El regalo perfecto para ella. Incluye 3 miniaturas de 30ml: Rose Noir, Fleur Blanche y Velvet Femme en elegante estuche.",
      price: 150,
      stock: 10,
      category: sets,
      ...
      variantImages: {
        [`Presentación:Estuche Clásico`]: IMG(P.p1b),
        [`Presentación:Estuche Lujo`]:    IMG(P.p2a),
      },
      isActive: true,
    },
    {
      name: "Set Him & Her",
      slug: "set-him-her",
      description: "El regalo ideal para parejas. Incluye Black Cedar 50ml + Fleur Blanche 50ml en estuche de lujo. Perfecto para aniversarios.",
      price: 180,
      stock: 8,
      category: sets,
      ...
      variantImages: {
        [`Presentación:Caja Regalo`]:  IMG(P.p4b),
        [`Presentación:Bolsa Premium`]: IMG(P.p2b),
      },
      isActive: true,
    },
    {
      ...
      description: "Descubre tu fragancia favorita. 5 miniaturas de 10ml con nuestras fragancias más queridas. Ideal para viajes o regalar.",
      price: 65,
      stock: 30,
      category: sets,
      ...
      variantImages: {
        [`Colección:Femenina`]:  IMG(P.p6a),
        [`Colección:Masculina`]: IMG(P.p3a),
        [`Colección:Mixta`]:     IMG(P.p1a),
      },
      isActive: true,
    },
    // ── Corporales ───────────────────────────────────────────────────────────
    {
      name: "Body Silk Femme",
      slug: "body-silk-femme",
      description: "Loción corporal ultra hidratante con notas de rosa damascena y manteca de karité. Piel suave, luminosa y perfumada todo el día.",
      price: 45,
      stock: 25,
      category: corporal,
      ...
      variantImages: {
        [`Aroma:Rosa`]:    IMG(P.p3b),
        [`Aroma:Coco`]:    IMG(P.p2b),
        [`Aroma:Vainilla`]: IMG(P.p1b),
      },
      isActive: true,
    },
    {
      name: "Body Mist Fresco",
      slug: "body-mist-fresco",
      description: "Bruma corporal ligera y refrescante. Notas cítricas de bergamota, limón y un toque de flores blancas.",
      price: 35,
      stock: 30,
      category: corporal,
      ...
      variantImages: {
        [`Fragancia:Cítrico`]:  IMG(P.p5a),
        [`Fragancia:Floral`]:   IMG(P.p6b),
        [`Fragancia:Acuático`]: IMG(P.p4a),
      },
      isActive: true,
    },
    {
      name: "Gold Elixir",
      slug: "gold-elixir",
      description: "Aceite corporal seco con destellos dorados. Fórmula no grasa que hidrata profundamente con aroma a vainilla y ámbar.",
      price: 55,
      stock: 20,
      category: corporal,
      ...
      variantImages: {
        [`Acabado:Dorado`]:   IMG(P.p6b),
        [`Acabado:Plateado`]: IMG(P.p5b),
        [`Acabado:Rosado`]:   IMG(P.p4b),
      },
      isActive: true,
    },
  ];
...
async function main() {
  ...
  if (RESET) {
    console.log("Resetting existing categories and products...");
  ...
  for (const p of products) {
    ...
    if (existing) {
      ...
      console.log(`  [ok]   "${p.name}" — $${p.price} | variantes: ${p.variants.map((v) => v.name).join(", ")}`);
      created++;
    }
  }

  console.log(`\nDone! ${created} productos creados, ${skipped} omitidos.`);
  console.log('Para reiniciar con datos frescos: node scripts/seed-store.js --reset\n');
